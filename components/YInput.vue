<template>
  <div>
    <div v-if="label" class="mb-1 text-truncate">
      <label :for="id" class="subtitle-1 font-weight-bold text--secondary">{{ label }}</label>
    </div>
...
::v-deep .v-text-field--filled.v-input--dense.v-text-field--single-line > .v-input__control > .v-input__slot,
::v-deep .v-text-field--filled.v-input--dense.v-text-field--outlined > .v-input__control > .v-input__slot,
::v-deep
  .v-text-field--filled.v-input--dense.v-text-field--outlined.v-text-field--filled
  > .v-input__control
  > .v-input__slot,
::v-deep .v-text-field--full-width.v-input--dense.v-text-field--single-line > .v-input__control > .v-input__slot,
::v-deep .v-text-field--full-width.v-input--dense.v-text-field--outlined > .v-input__control > .v-input__slot,
::v-deep
